...
<body>
    <div style="margin: 8px;">
        ...
        <table>
            ...
            <?php foreach ($telephones as $telephone => $prix) : ?>
                <tr>
                    ...
                    <td><a href="ajout_article.php?telephone=<?php echo urlencode($telephone); ?>" style="background-color: mediumslateblue;">Ajouter</a></td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <a href="calcul_total.php">Calculer le total</a><br>
